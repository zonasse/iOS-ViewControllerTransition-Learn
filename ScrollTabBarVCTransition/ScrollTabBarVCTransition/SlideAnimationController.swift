...
class SlideAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        case .tabTransition(let direction):
            ...
            fromViewTransform = CGAffineTransform(translationX: translation, y: translation)
            toViewTransform = CGAffineTransform(translationX: translation, y: translation)
            toViewTransform = toViewTransform.rotated(by: 0.5)
